...
void EditDuplicateLine(HWND);
void EditCutLine(HWND);
void EditCopyLine(HWND);
void EditDeleteLine(HWND);
void EditDeleteLineLeft(HWND);
void EditDeleteLineRight(HWND);
void EditSelectWord(HWND);
void EditSelectLine(HWND);
void EditDuplicateSelection(HWND);
void EditIndent(HWND, BOOL);
void EditUnindent(HWND, BOOL);
void EditInsertDate(HWND, BOOL);
void EditInsertFileOrPath(HWND, LPCWSTR, BOOL);
void EditCommentLine(HWND);
void EditStreamCommentLine(HWND);
